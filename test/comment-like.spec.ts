...
describe('like Comments', () => {
  ...
  describe('POST /threads/:threadId/comments/:commentId/like', () => {
    beforeEach(async () => {
    ...
    it('should be rejected if not login', async () => {
      ...
      const response = await request(app.getHttpServer()).post(
        `/threads/${thread.id}/comments/${comment.id}/like`,
      );
    ...
    it('should be rejected if thread notfound', async () => {
      ...
      const response = await request(app.getHttpServer())
        .post(`/threads/${thread.id + 1}/comments/${comment.id}/like`)
        .set('Cookie', cookies);
    ...
    it('should be rejected if comment notfound', async () => {
      ...
      const comment = await testService.getComment();
      const response = await request(app.getHttpServer())
        .post(`/threads/${thread.id}/comments/${comment.id + 1}/like`)
        .set('Cookie', cookies);
    ...
    it('should be able to like comment', async () => {
      const cookies = await loginAndGetCookie();
      const thread = await testService.getThread();
      const comment = await testService.getComment();
      const response = await request(app.getHttpServer())
        .post(`/threads/${thread.id}/comments/${comment.id}/like`)
        .set('Cookie', cookies);
  ...
  describe('DELETE /threads/:threadId/comments/:commentId/like', () => {
    beforeEach(async () => {
      await testService.deleteAll();
      await testService.createUser();
      await testService.createThread();
    ...
    it('should be rejected if thread notfound', async () => {
      ...
      const comment = await testService.getComment();
      const response = await request(app.getHttpServer())
        .delete(`/threads/${thread.id + 1}/comments/${comment.id}/like`)
        .set('Cookie', cookies);
    ...
    it('should be rejected if comment notfound', async () => {
      ...
      const comment = await testService.getComment();
      const response = await request(app.getHttpServer())
        .delete(`/threads/${thread.id}/comments/${comment.id + 1}/like`)
        .set('Cookie', cookies);
    ...
    it('should be rejected if like user and request user is not same', async () => {
      const thread = await testService.getThread();
      const comment = await testService.getComment();
      const response = await request(app.getHttpServer())
        .delete(`/threads/${thread.id}/comments/${comment.id}/like`)
    ...
    it('should be able remove like comment', async () => {
      const cookies = await loginAndGetCookie();
      const thread = await testService.getThread();
      const comment = await testService.getComment();
      const user = await testService.getUser();
      await testService.createLikeComment(comment.id, user.id);
      const response = await request(app.getHttpServer())
        .delete(`/threads/${thread.id}/comments/${comment.id}/like`)
        .set('Cookie', cookies);
